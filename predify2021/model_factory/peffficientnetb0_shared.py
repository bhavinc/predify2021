...
from .deep_networks import DeepPNetSeparateHP


class PEfficientNetB0_SeparateHP(PNetSeparateHP):
...
class DeepPEfficientNetB0_SeparateHP(DeepPNetSeparateHP):

    def __init__(self, backbone, number_of_pcoders, number_of_timesteps,build_graph=False, random_init=False, ff_multiplier=(0.3,0.3,0.3,0.3,0.3,0.3,0.3,0.3), fb_multiplier=(0.3,0.3,0.3,0.3,0.3,0.3,0.3,0.3), er_multiplier=(0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.01)):
        super().__init__(backbone, number_of_pcoders=8,number_of_timesteps=number_of_timesteps ,build_graph=build_graph, random_init=random_init, ff_multiplier=ff_multiplier, fb_multiplier=fb_multiplier, er_multiplier=er_multiplier)
